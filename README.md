...
| `flat_limits`                  | When True, will not calculate between the max/min supported limits of your light. Example: when adapting brightness to 50% while max_brightness is set to 80%, Adaptive Lighting will use 80% instead of 90% | `False`        | `bool`                               |
