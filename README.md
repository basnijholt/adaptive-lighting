...
| `send_split_delay`             | Wait time (milliseconds) between commands when using `separate_turn_on_commands`. Some lights do not support setting brightness and color simultaneously. ⏲️                    | `0`            | `int` 0-10000                        |
