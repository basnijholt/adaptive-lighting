...
Adaptive Lighting expands Home Assistant Light Groups only one level deep, and nested groups can prevent lights from being adapted at all (see [#1378](https://github.com/basnijholt/adaptive-lighting/issues/1378)).
