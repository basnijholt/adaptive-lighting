...
| `skip_brightness_increases`                 | Prevent automatic adaptation from increasing brightness above a reported numeric brightness, while still allowing dimming and color adaptation.                                                                                                                                                                                                                                               | `False`        | `bool`                                  |
