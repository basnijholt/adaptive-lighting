...
CONF_SUNRISE_OFFSET_COLOR, DEFAULT_SUNRISE_OFFSET_COLOR = "sunrise_offset_color", 0
CONF_SUNRISE_TIME = "sunrise_time"
CONF_SUNSET_OFFSET, DEFAULT_SUNSET_OFFSET = "sunset_offset", 0
CONF_SUNSET_OFFSET_COLOR, DEFAULT_SUNSET_OFFSET_COLOR = "sunset_offset_color", 0
...
VALIDATION_TUPLES = [
    ...
    (CONF_SUNRISE_OFFSET_COLOR, DEFAULT_SUNRISE_OFFSET_COLOR, int),
    (CONF_SUNSET_TIME, NONE_STR, str),
    (CONF_SUNSET_OFFSET, DEFAULT_SUNSET_OFFSET, int),
    (CONF_SUNSET_OFFSET_COLOR, DEFAULT_SUNSET_OFFSET_COLOR, int),
...
EXTRA_VALIDATION = {
    ...
    CONF_SUNRISE_OFFSET_COLOR: (cv.time_period, timedelta_as_int),
    CONF_SUNRISE_TIME: (cv.time, str),
    CONF_SUNSET_OFFSET: (cv.time_period, timedelta_as_int),
    CONF_SUNSET_OFFSET_COLOR: (cv.time_period, timedelta_as_int),
