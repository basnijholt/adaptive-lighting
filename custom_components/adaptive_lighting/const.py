...
# Items not put in a section will be put at top level and be immediately visible.
# Item order is determined by VALIDATION_TUPLES.

SECTION_SLEEP: set[str] = {
